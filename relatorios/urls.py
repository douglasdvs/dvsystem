...
urlpatterns = [
    ...
    path(
        "clientes/sem-compras/export/",
        views.relatorio_clientes_sem_compras_export,
        name="relatorio_clientes_sem_compras_export",
    ),
    ...
    path(
        "vendas-por-vendedor/export/",
        views.relatorio_vendas_por_vendedor_export,
        name="relatorio_vendas_por_vendedor_export",
    ),
]
