...
class Produto(models.Model):
    ...
    categoria = models.ForeignKey(
        CategoriaProduto, on_delete=models.SET_NULL, null=True, blank=True, related_name="produtos"
    )
    ...
    def save(self, *args, **kwargs):
        ...
        if self.codigo_barras:
            self.codigo_barras = self.codigo_barras.upper()
        # Adicione outros campos de texto se necessário
        if not self.codigo:
