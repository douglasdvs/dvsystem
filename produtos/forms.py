...
from .models import Produto, CategoriaProduto, MovimentoEstoque, HistoricoPreco, CATEGORIAS_PRODUTO

class ProdutoForm(forms.ModelForm):
    class Meta:
        model = Produto
        fields = [
            'descricao', 'categoria', 'preco_custo', 'margem_lucro', 'preco_venda',
            'estoque', 'estoque_minimo', 'unidade_medida', 'ativo'
        ]
        widgets = {
