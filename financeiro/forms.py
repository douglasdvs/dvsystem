...
from .models import CentroCusto, Despesa, Receita
...
class RelatorioForm(forms.Form):
    ...
    data_inicio = forms.DateField(
        widget=forms.DateInput(attrs={"class": "form-control", "type": "date"}), label="Data Início"
    )
    data_fim = forms.DateField(
        widget=forms.DateInput(attrs={"class": "form-control", "type": "date"}), label="Data Fim"
    )
